...
from simlearner3d.processing.dataset.hdf5 import HDF5Dataset, BareDataset
...
class BareStereoDataModule(LightningDataModule):
    ...
    @property
    def dataset(self) -> BareDataset:
        """Create dataset from list of files without creating a hdf5 file.
